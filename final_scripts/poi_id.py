...
analyze_feature.remove_keys(data_dict, outlier_keys)

# instantiate copies of dataset and features for testing purposes
...
best_features = analyze_feature.get_k_best(my_dataset, my_feature_list, num_features)
my_feature_list = [target_label] + best_features.keys()

# add two new features
analyze_feature.add_financial_aggregate(my_dataset, my_feature_list)
analyze_feature.add_poi_interaction(my_dataset, my_feature_list)
